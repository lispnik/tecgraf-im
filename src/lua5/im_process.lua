...
OneSourceOneDest("ProcessLensDistort")
...
OneSourceOneDest("ProcessBinThinNhMaps")
OneSourceOneDest("ProcessBinThinZhangSuen")
...
OneSourceOneDest("ProcessQuantizeRGBMedianCut", nil, nil, im.MAP, nil)
OneSourceOneDest("ProcessQuantizeGrayMedianCut")
...
OneSourceOneDest("ProcessSelectHSI")
...
OneSourceOneDest("ProcessShiftHSI")
OneSourceOneDest("ProcessShiftComponent")
OneSourceOneDest("ProcessDecorrelationStretch")
OneSourceOneDest("ProcessDecorrelationApplyTransform")
...
OneSourceOneDest("ProcessDiffusionErrThreshold")
...
OneSourceOneDest("ProcessThresholdSaturation", nil, nil, im.BINARY, nil)
